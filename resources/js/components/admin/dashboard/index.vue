<template>
    ...
    <div class="app-toolbar-wrapper w-100 mb-8">
        ...
        <div class="d-flex flex-stack mb-2">
            ...
            <!--end::Title-->
            <!--begin::Action-->
            <a href="#" class="btn btn-color-gray-500 fw-semibold" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">View All</a>
            <!--end::Action-->
        </div>
        <!--end::Wrapper-->
        <!--begin::Navs-->
        <div class="nav d-flex justify-content-xxl-between flex-wrap gap-5">
            ...
            <li class="nav-item mb-2">
                <!--begin::Nav link-->
                <a class="nav-link btn btn-active-success btn-center bg-gray-100 btn-color-gray-600 rounded-3 flex-column overflow-hidden w-90px h-85px pt-7 pt-lg-5 pb-2 active" data-bs-toggle="tab" href="#">
                    <!--begin::Icon-->
            ...
            <li class="nav-item mb-2">
                <!--begin::Nav link-->
                <a class="nav-link btn btn-active-success btn-center bg-gray-100 btn-color-gray-600 rounded-3 flex-column overflow-hidden w-90px h-85px pt-7 pt-lg-5 pb-2" data-bs-toggle="tab" href="#">
                    <!--begin::Icon-->
                    <div class="nav-icon mb-3">
        ...
        <div class="col-xl-8">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7">
                    ...
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        <a href="../../demo51/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">History</a>
                    </div>
                    <!--end::Toolbar-->
                </div>
                <!--end::Header-->
        ...
        <div class="col-xl-4 mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7 mb-7">
                    ...
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        <a href="../../demo51/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">PDF Report</a>
                    </div>
                    <!--end::Toolbar-->
                </div>
                <!--end::Header-->
