<template>
    <div class="ermys-bg">
        <div class="ermys-container">
            <!-- Bienvenida -->
            <section class="ermys-hero">
                <div>
            ...
            <section class="ermys-section ermys-values">
                <div>
                    <h3>Misión</h3>
                    <p>
            ...
            <!-- Contacto / CTA -->
            <section class="ermys-section ermys-contact">
...
.ermys-section p, .ermys-section ul {
    color: #444;
    font-size: 1.08rem;
    margin-bottom: 12px;
}
...
.ermys-service-card:hover {
    transform: translateY(-6px) scale(1.04);
    box-shadow: 0 6px 24px #2d8cf033;
}
.ermys-service-card img {
    width: 90px;
    height: 90px;
    object-fit: cover;
    border-radius: 50%;
...
.ermys-team-member:hover {
    transform: scale(1.05);
    box-shadow: 0 6px 24px #2d8cf033;
}
.ermys-team-member img {
    width: 70px;
    height: 70px;
    object-fit: cover;
    border-radius: 50%;
...
.ermys-team-member h5 {
    color: #2d8cf0;
    font-size: 1.05rem;
    font-weight: 700;
    margin-bottom: 2px;
}
.ermys-team-member span {
    color: #19be6b;
    font-size: 0.98rem;
    font-weight: 500;
}
...
.ermys-contact {
    text-align: center;
    background: linear-gradient(90deg, #e0f7fa 60%, #f0f9eb 100%);
...
@media (max-width: 900px) {
    ...
    .ermys-values, .ermys-services, .ermys-team, .ermys-testimonials {
        flex-direction: column;
        gap: 16px;
    }
}
